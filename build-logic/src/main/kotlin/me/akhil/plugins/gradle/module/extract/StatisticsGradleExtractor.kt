package me.akhil.plugins.gradle.module.extract

import me.akhil.plugins.gradle.module.ArtifactDependencyType
import me.akhil.plugins.gradle.module.FileType
import me.akhil.plugins.gradle.module.FileTypeStatistics
import me.akhil.plugins.gradle.module.ModuleArtifactDependency
import me.akhil.plugins.gradle.module.ModuleMetadata
import me.akhil.plugins.gradle.module.ModuleStatistics
import me.akhil.plugins.gradle.module.ModuleType
import me.akhil.plugins.gradle.module.ProjectStatistics
...
class StatisticsGradleExtractor {
    ...
    fun extract(project: Project): ProjectStatistics {
        ...
        return ProjectStatistics(
            ...
            prodKotlinTotalLines = moduleStats.sumOf { module -> module.containedProdFiles.single { it.type == FileType.KOTLIN }.lineCount },

            prodJavaTotalLines = moduleStats.sumOf { module -> module.containedProdFiles.single { it.type == FileType.JAVA }.lineCount },

            prodXmlTotalLines = moduleStats.sumOf { module -> module.containedProdFiles.single { it.type == FileType.XML }.lineCount }
        )
    }
    ...
    private fun extractDependencies(module: Project): List<ModuleArtifactDependency> {
        ...
        return module.configurations
            ...
            .flatMap { configuration ->
                val projectDependencies = configuration.allDependencies.filterIsInstance<ProjectDependency>()
